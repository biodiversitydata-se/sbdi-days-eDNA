...
In this section we repeat parts of the workflow using 18S data. We will compute Bray–Curtis distances based on genus-level composition and run a PCoA.
...
[← Previous](tutorial-06-randomforest.qmd) · [Overview](index.qmd)
