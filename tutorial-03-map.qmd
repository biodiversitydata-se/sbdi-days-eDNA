...
We now extract salinity and temperature for all samples. Because these variables are recorded differently in the two datasets, values are taken from different columns, and temperature for the 2019–2020 dataset is calculated as a mean across multiple depths.
